...
func Load() (*Config, error) {
    ...
    return &Config{
        ...
        AAA: AAAConfig{
            ...
            TimeoutMs:                  getEnvAsInt("AAA_TIMEOUT_MS", 5000),
            Retries:                    getEnvAsInt("AAA_RETRIES", 3),
            GRPCServerAddr:             getEnv("AAA_GRPC_SERVER_ADDR", "localhost:50051"),
            TLSEnabled:                 getEnvAsBool("AAA_GRPC_TLS_ENABLED", false),
            CertPath:                   getEnv("AAA_GRPC_CERT_PATH", ""),
            KeyPath:                    getEnv("AAA_GRPC_KEY_PATH", ""),
            CAPath:                     getEnv("AAA_GRPC_CA_PATH", ""),
            ServerName:                 getEnv("AAA_GRPC_SERVER_NAME", ""),
