...
// @Success 200 {object} common.Response{data=[]catalogResponses.CatalogItemResponse,meta=common.ResponseMeta{pagination=common.PaginationMeta}}
...
// @Param item body catalogRequests.UpdateCatalogItemRequest true "Item updates"
