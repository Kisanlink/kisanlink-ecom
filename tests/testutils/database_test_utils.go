...
func MockDatabaseError(mockDB *MockDatabase, errorMsg string) {
    mockDB.On("Exec", mock.AnythingOfType("string"), mock.Anything).Return(nil, fmt.Errorf(errorMsg))
}

func MockQueryError(mockDB *MockDatabase, errorMsg string) {
    mockDB.On("Query", mock.AnythingOfType("string"), mock.Anything).Return(nil, fmt.Errorf(errorMsg))
}
...
func MockTransactionRollback(mockDB *MockDatabase, mockTx *MockTransaction, errorMsg string) {
    mockDB.On("Begin").Return(mockTx, nil)
    mockTx.On("Exec", mock.AnythingOfType("string"), mock.Anything).Return(nil, fmt.Errorf(errorMsg))
...
func MockUnhealthyDatabase(mockDB *MockDatabase, errorMsg string) {
    mockDB.On("Ping").Return(fmt.Errorf(errorMsg))
    mockDB.On("PingContext", mock.Anything).Return(fmt.Errorf(errorMsg))
}
...
func MockConcurrentAccess(mockDB *MockDatabase, conflictError string) {
    ...
    mockDB.On("Exec", mock.AnythingOfType("string"), mock.Anything).Return(nil, fmt.Errorf(conflictError)).Once()
}
